...
/// <summary>
/// Fixture for Sale update tests that provides an isolated PostgreSQL schema.
...
/// </summary>
public class SaleUpdateTestsFixture : PostgreSqlContainerFixture
{
    private const string SchemaName = "sale_update_tests";
