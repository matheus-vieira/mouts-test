...
/// <summary>
/// Fixture for Sale delete tests that provides an isolated PostgreSQL schema.
...
/// </summary>
public class SaleDeleteTestsFixture : PostgreSqlContainerFixture
{
    private const string SchemaName = "sale_delete_tests";
