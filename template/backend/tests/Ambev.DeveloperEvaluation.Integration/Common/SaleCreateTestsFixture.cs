...
/// <summary>
/// Fixture for Sale creation tests that provides an isolated PostgreSQL schema.
...
/// </summary>
public class SaleCreateTestsFixture : PostgreSqlContainerFixture
{
    private const string SchemaName = "sale_create_tests";
